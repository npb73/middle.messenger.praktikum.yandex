...
В третьем спринте был добавлен роутинг. И без авторизации пользователю будут доступны только следующие страницы: 
- [Страница авторизации](https://hilarious-douhua-520b9f.netlify.app/login)
- [Страница регистрации](https://hilarious-douhua-520b9f.netlify.app/signup)

Так же был подключен Yandex API, и доработан основной функционал для обмений сообщений с пользователями.
